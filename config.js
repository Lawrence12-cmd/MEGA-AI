...
const defaultOwner = '233534776945';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '' ; //  your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '233534776944' ;  // put your number here
